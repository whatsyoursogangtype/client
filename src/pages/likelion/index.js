  ...
  return (
    <Flex>
      ...
      <WhiteBox>
        ...
        <div>
          <Text>
            멋쟁이사자처럼 유형의 사람들은 자신의 아이디어를 누군가에게 전달하고, 그것이 실현되는 과정에서 함께 참여하고
            싶어합니다. 새로운 아이디어를 제안하고, 팀의 역량을 살려 아이디어를 구현하는 것을 즐기며, 문제가 발생해도
            단순히 해결하는 것보다는 그 과정에서 무엇을 배울 수 있는지에 관심이 많습니다. 이 유형의 사람들은 적극적으로
            도전을 시도하고, 실패해도 그것을 극복하면서 성장하는 모습을 보입니다.
          </Text>
        </div>
        <br />
        <br />
