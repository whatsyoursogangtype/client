...
export const types = {
  SJL: {
    ...
    desc: [
      ...
      "커피브레이크형은 학교 생활에서 학업에 최대한 집중하고, 자신의 진로에 대한 명확한 비전을 가지고 있습니다. 또한, 그들은 팀 프로젝트에서 팀장 역할을 선호하며, 조직력과 리더십 능력이 뛰어납니다.이 유형의 사람들은 매우 집중력이 뛰어나며, 학업이나 진로와 관련된 일에 대한 열정과 몰입력이 높습니다. 그러나, 다른 사람들과 대화를 나누거나 네트워킹하는 것보다는 스스로 공부하는 것을 좋아합니다. 또한, 자신의 생각을 확고하게 가지고 있어서 다른 사람의 의견을 수용하기 어려울 수 있습니다.팀 프로젝트에서 팀장 역할을 맡으면, 이들은 팀의 목표를 달성하기 위해 자신의 목표와 노력을 전체 팀원들과 공유합니다. 그리고 각자의 역할과 책임을 명확히 분담하고, 팀원들의 역량을 고려해 역할을 배분합니다. 이들은 대부분 효율적인 일처리와 전략적인 계획 수립 등에 능합니다.",
    ],
  ...
  SJM: {
    ...
    desc: [
      "자네.. 내 연구실에 들어올 생각 없나?",
      "로욜라형은 학업에 집중하면서도 진로가 명확하게 정해져 있어서 해당 분야에서의 경력을 쌓으려는 생각을 가지고 있습니다. 또한, 다른 사람들과 함께 일하는 것을 좋아하지만, 팀의 리더로서 주도적인 역할을 맡지는 않으며 팀 내에서 각자의 역할을 잘 수행하려고 노력합니다. 전체적으로, 이 유형의 사람들은 명확한 진로를 향해 나아가면서도 팀원들과 함께 협력하여 목표를 달성하는 것을 중요시하고 있습니다.",
    ],
    image: "loyola.png",
  },
  SIL: {
    ...
    desc: [
      ...
      "X관랩실형은 학교생활에서 주로 학업에 집중하면서 다양한 경험을 쌓으려는 유형입니다. 새로운 일을 시도하고 도전하는 것을 좋아하지만, 그 전에 먼저 자신의 업무나 학업에 충실하고자 합니다. 이 유형의 사람들은 일단 무언가에 도전해보고, 그 결과를 토대로 결정을 내리는 경향이 있습니다. 그래서 자신이 관심 있는 분야에 대해서는 빠르게 배우고 성장할 수 있습니다. 또한, 이 유형의 사람들은 다양한 경험을 쌓기 위해 학교 생활에서 봉사활동, 동아리 활동, 대외활동 등 다양한 활동에 참여합니다. 이 유형의 사람들은 팀플에서는 주로 팀장 역할을 맡으며, 팀원들에게 일의 목표와 방향성을 제시하고 일의 진행 상황을 적극적으로 관리하며, 갈등이나 문제가 발생했을 때 이를 해결하기 위해 노력합니다.",
    ],
    image: "xlab.png",
  },
  SIM: {
  ...
  RJM: {
    ...
    desc: [
      "경의선 숲길을 따라 앞으로 전진!",
      "경의선숲길형은 진로에 대한 명확한 목표를 가지고 있으며, 이를 위해 꾸준한 노력과 열정으로 공부를 하며 자신의 능력을 향상시키려 합니다. 또한 인맥 형성을 중요하게 생각하지만, 이를 위해서는 진로와 연관된 사람들과 관계를 형성하려 합니다. 또한, 팀플에 참여할 때는 팀원들의 강점과 약점을 파악하고, 그에 따라 효율적인 역할 분담을 결정합니다. 상황에 따라 팀을 이끌기도 하지만, 능동적으로 협력하여 팀 전체의 목표를 달성하려 노력합니다. 이 유형의 학생들은 진로에 대한 목표를 달성하기 위해 협력과 노력을 아끼지 않으며, 인맥 형성도 중요시하여 다양한 사람들과 관계를 형성하려 합니다.",
    ],
    image: "forest.png",
  },
  RIL: {
    ...
    desc: [
      ...
      '빨간잠망경형은 인맥형성형에서처럼 네트워킹이 중요하다는 인식을 가지고 있지만, 동시에 새로운 경험을 즐기는 "일단해보자형" 성격을 가지고 있습니다. 따라서 학교생활을 통해 다양한 경험을 쌓고, 그 과정에서 사람들과 인맥을 형성하며 즐기는 측면이 강합니다. 또한, 이 유형의 사람들은 "팀플팀장형" 성격을 가지고 있어서, 자신이 관심있는 분야에서 주도적으로 팀을 이끌며 목표를 달성하고자 하는 경향이 있습니다. 이러한 성격 덕분에 팀원들의 역할 분담과 시간 관리를 잘하며, 팀 프로젝트에서 좋은 성과를 내는 경우가 많습니다. 이 유형의 사람들은 새로운 도전을 즐기는 면과 주도적인 성격을 가지고 있어, 다른 사람들과 함께 일하는 것을 좋아합니다. 그러나 동시에 네트워킹에 대한 중요성도 인식하고 있어, 인간관계를 형성하며, 사회성을 발전시키고자 하는 경향이 있습니다.',
    ],
    image: "sinchon.png",
  },
  RIM: {
